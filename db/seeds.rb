...
normal_user = User.create(name: 'Normal User',
                          ...
                          admin: false)
book1 = Book.create(isbn: '1234567890',
                    title: 'sample1_title',
                    ...
                    page: 300)
book2 = Book.create(isbn: '1234567890123',
                    title: 'sample2_title',
...
history1 = History.create(concrete_history: read_history1, card_id: card1.id)
history2 = History.create(concrete_history: read_history2, card_id: card1.id)
history3 = History.create(concrete_history: register_history1, card_id: card1.id,)
history4 = History.create(concrete_history: register_history2, card_id: card2.id)
